...
namespace ProjectEternity.Core.Online
{
    public class Client
    {
        ...
        public readonly List<RoomInformations> ListAllRoom;
        ...
        public void ConnectToRoom(RoomInformations RoomToConnect)
        {
        ...
        {
            Host.Send(new CreateRoomScriptClient(RoomName));
        }
        ...
        {
            byte[] ArrayGameData = CurrentGame.GetSnapshotData();
        }
